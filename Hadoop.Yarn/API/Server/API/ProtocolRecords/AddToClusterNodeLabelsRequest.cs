...
namespace Org.Apache.Hadoop.Yarn.Server.Api.Protocolrecords
{
	...
	{
		public static AddToClusterNodeLabelsRequest NewInstance(ICollection<string> labels
			)
		{
			AddToClusterNodeLabelsRequest request = Records.NewRecord<AddToClusterNodeLabelsRequest
				>();
