...
namespace Org.Apache.Hadoop.Registry.Client.Exceptions
{
	...
	public class InvalidPathnameException : RegistryIOException
	{
		...
		public InvalidPathnameException(string path, string message, Exception cause)
