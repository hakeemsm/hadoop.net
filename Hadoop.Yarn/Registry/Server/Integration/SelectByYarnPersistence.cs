...
{
	/// <summary>Select an entry by the YARN persistence policy</summary>
	public class SelectByYarnPersistence : RegistryAdminService.NodeSelector
	{
		private readonly string id;

		private readonly string targetPolicy;
