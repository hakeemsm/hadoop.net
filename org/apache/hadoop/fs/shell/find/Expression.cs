...
namespace org.apache.hadoop.fs.shell.find
{
	...
	public interface Expression
	{
		...
		void setOptions(org.apache.hadoop.fs.shell.find.FindOptions options);
		...
		/// </returns>
		/// <exception cref="System.IO.IOException"/>
		org.apache.hadoop.fs.shell.find.Result apply(org.apache.hadoop.fs.shell.PathData 
			item, int depth);
		...
		void addChildren(java.util.Deque<org.apache.hadoop.fs.shell.find.Expression> expressions
			);
		...
		void addArguments(java.util.Deque<string> args);
	}
}
