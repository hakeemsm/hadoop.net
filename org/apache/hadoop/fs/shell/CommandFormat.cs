...
namespace org.apache.hadoop.fs.shell
{
	...
	public class CommandFormat
	{
		...
		internal readonly System.Collections.Generic.IDictionary<string, bool> options = 
		...
		public virtual System.Collections.Generic.IList<string> parse(string[] args, int 
			pos)
		{
			System.Collections.Generic.IList<string> parameters = new System.Collections.Generic.List
		...
		public virtual void parse(System.Collections.Generic.IList<string> args)
		{
			int pos = 0;
			while (pos < args.Count)
			{
				...
				else
				{
					...
					{
						throw new org.apache.hadoop.fs.shell.CommandFormat.UnknownOptionException(arg);
					}
				}
			}
			...
			if (psize < minPar)
			{
				throw new org.apache.hadoop.fs.shell.CommandFormat.NotEnoughArgumentsException(minPar
					, psize);
			}
			if (psize > maxPar)
			{
				throw new org.apache.hadoop.fs.shell.CommandFormat.TooManyArgumentsException(maxPar
					, psize);
			}
		}
		...
		public virtual System.Collections.Generic.ICollection<string> getOpts()
		{
			System.Collections.Generic.ICollection<string> optSet = new java.util.HashSet<string
				>();
			foreach (System.Collections.Generic.KeyValuePair<string, bool> entry in options)
			{
				if (entry.Value)
				{
					optSet.add(entry.Key);
				}
			}
			return optSet;
		}
		...
		[System.Serializable]
		public abstract class IllegalNumberOfArgumentsException : System.ArgumentException
		{
		...
		[System.Serializable]
		public class TooManyArgumentsException : org.apache.hadoop.fs.shell.CommandFormat.IllegalNumberOfArgumentsException
		{
			private const long serialVersionUID = 0L;
		...
		[System.Serializable]
		public class NotEnoughArgumentsException : org.apache.hadoop.fs.shell.CommandFormat.IllegalNumberOfArgumentsException
		{
			private const long serialVersionUID = 0L;
		...
		[System.Serializable]
		public class UnknownOptionException : System.ArgumentException
		{
			private const long serialVersionUID = 0L;
