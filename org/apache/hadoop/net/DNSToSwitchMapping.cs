...
namespace org.apache.hadoop.net
{
	...
	public interface DNSToSwitchMapping
	{
		...
		/// should return
		/// <see cref="NetworkTopology.DEFAULT_RACK"/>
		/// . This
		...
		/// </returns>
		System.Collections.Generic.IList<string> resolve(System.Collections.Generic.IList
			<string> names);
		...
		/// </remarks>
		void reloadCachedMappings(System.Collections.Generic.IList<string> names);
	}
}
