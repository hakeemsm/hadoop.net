...
namespace org.apache.hadoop.crypto
{
	...
	[System.Serializable]
	public class UnsupportedCodecException : System.Exception
	{
		...
		public UnsupportedCodecException(string message, System.Exception cause)
			: base(message, cause)
		{
		}
		...
		/// <param name="cause">the cause</param>
		public UnsupportedCodecException(System.Exception cause)
			: base(cause)
		{
		}
