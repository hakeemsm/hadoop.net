...
namespace org.apache.hadoop.util
{
	...
	public interface IndexedSorter
	{
		...
		void sort(org.apache.hadoop.util.IndexedSortable s, int l, int r);
		...
		void sort(org.apache.hadoop.util.IndexedSortable s, int l, int r, org.apache.hadoop.util.Progressable
			 rep);
	}
}
