...
namespace org.apache.hadoop.util
{
	...
	public class ProgramDriver
	{
		...
		/// </summary>
		internal System.Collections.Generic.IDictionary<string, org.apache.hadoop.util.ProgramDriver.ProgramDescription
			> programs;

		public ProgramDriver()
		{
			programs = new System.Collections.Generic.SortedDictionary<string, org.apache.hadoop.util.ProgramDriver.ProgramDescription
				>();
		}

		private class ProgramDescription
		{
			internal static readonly java.lang.Class[] paramTypes = new java.lang.Class[] { Sharpen.Runtime.getClassForType
				(typeof(string[])) };
			...
			/// 	</exception>
			public ProgramDescription(java.lang.Class mainClass, string description)
			{
		...
		private static void printUsage(System.Collections.Generic.IDictionary<string, org.apache.hadoop.util.ProgramDriver.ProgramDescription
			> programs)
		{
			System.Console.Out.WriteLine("Valid program names are:");
			foreach (System.Collections.Generic.KeyValuePair<string, org.apache.hadoop.util.ProgramDriver.ProgramDescription
				> item in programs)
			{
		...
		public virtual void addClass(string name, java.lang.Class mainClass, string description
			)
		{
			programs[name] = new org.apache.hadoop.util.ProgramDriver.ProgramDescription(mainClass
				, description);
		}
		...
		/// <exception cref="System.MissingMethodException"></exception>
		/// <exception cref="System.Security.SecurityException"></exception>
		/// <exception cref="java.lang.IllegalAccessException"></exception>
		...
		public virtual int run(string[] args)
		{
			...
			// And that it is good.
			org.apache.hadoop.util.ProgramDriver.ProgramDescription pgm = programs[args[0]];
			if (pgm == null)
			{
