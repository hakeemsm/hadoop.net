...
namespace org.apache.hadoop.util
{
	...
	/// line.
	/// </remarks>
	public class LineReader : java.io.Closeable
	{
		...
		/// <exception cref="System.IO.IOException"/>
		public LineReader(java.io.InputStream @in, org.apache.hadoop.conf.Configuration conf
			)
		...
		public LineReader(java.io.InputStream @in, byte[] recordDelimiterBytes)
		{
			this.@in = @in;
		...
		/// <param name="recordDelimiterBytes">The delimiter</param>
		/// <exception cref="System.IO.IOException"/>
		public LineReader(java.io.InputStream @in, int bufferSize, byte[] recordDelimiterBytes
			)
		{
			this.@in = @in;
			this.bufferSize = bufferSize;
		...
		public virtual int readLine(org.apache.hadoop.io.Text str, int maxLineLength, int
			 maxBytesToConsume)
		{
		...
		/// <exception cref="System.IO.IOException"/>
		protected internal virtual int fillBuffer(java.io.InputStream @in, byte[] buffer, 
			bool inDelimiter)
		{
		...
		/// <exception cref="System.IO.IOException"/>
		private int readDefaultLine(org.apache.hadoop.io.Text str, int maxLineLength, int
			 maxBytesToConsume)
		{
			...
			*/
			...
			{
				throw new System.IO.IOException("Too many bytes before newline: " + bytesConsumed
					);
			}
		...
		/// <exception cref="System.IO.IOException"/>
		private int readCustomLine(org.apache.hadoop.io.Text str, int maxLineLength, int 
			maxBytesToConsume)
		{
			...
			*/
			...
			if (bytesConsumed > int.MaxValue)
			{
				throw new System.IO.IOException("Too many bytes before delimiter: " + bytesConsumed
					);
			}
			return (int)bytesConsumed;
		}
		...
		/// <exception cref="System.IO.IOException">if the underlying stream throws</exception>
		public virtual int readLine(org.apache.hadoop.io.Text str, int maxLineLength)
		{
		...
		/// <returns>the number of bytes read including the newline</returns>
		/// <exception cref="System.IO.IOException">if the underlying stream throws</exception>
		public virtual int readLine(org.apache.hadoop.io.Text str)
		{
