...
namespace org.apache.hadoop.record.compiler.generated
{
	...
	public class RccTokenManager : org.apache.hadoop.record.compiler.generated.RccConstants
	{
...
MatchLoop_break: ;
		...
		protected internal org.apache.hadoop.record.compiler.generated.SimpleCharStream input_stream;
		...
		public RccTokenManager(org.apache.hadoop.record.compiler.generated.SimpleCharStream
			 stream)
		{
			input_stream = stream;
		}
		...
		public virtual void ReInit(org.apache.hadoop.record.compiler.generated.SimpleCharStream
			 stream)
		{
		...
		public virtual void SwitchTo(int lexState)
		{
			...
			{
				throw new org.apache.hadoop.record.compiler.generated.TokenMgrError("Error: Ignoring invalid lexical state : "
					 + lexState + ". State unchanged.", org.apache.hadoop.record.compiler.generated.TokenMgrError
		...
		protected internal virtual org.apache.hadoop.record.compiler.generated.Token jjFillToken
			()
		{
			org.apache.hadoop.record.compiler.generated.Token t = org.apache.hadoop.record.compiler.generated.Token
		...
		public virtual org.apache.hadoop.record.compiler.generated.Token getNextToken()
		{
			int kind;
			org.apache.hadoop.record.compiler.generated.Token specialToken = null;
			org.apache.hadoop.record.compiler.generated.Token matchedToken;
			int curPos = 0;
			for (; ; )
			{
				try
				...
				for (; ; )
				{
					...
					throw new org.apache.hadoop.record.compiler.generated.TokenMgrError(EOFSeen, curLexState
						, error_line, error_column, error_after, curChar, org.apache.hadoop.record.compiler.generated.TokenMgrError
						.LEXICAL_ERROR);
				}
EOFLoop_continue: ;
			}
EOFLoop_break: ;
		...
		internal virtual void SkipLexicalActions(org.apache.hadoop.record.compiler.generated.Token
			 matchedToken)
		{
