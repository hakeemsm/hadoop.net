...
namespace org.apache.hadoop.metrics
{
	...
	public abstract class MetricsContext
	{
		...
		public const int DEFAULT_PERIOD = 5;
		...
		public abstract void init(string contextName, org.apache.hadoop.metrics.ContextFactory
			 factory);
		...
		/// 	</exception>
		public abstract org.apache.hadoop.metrics.MetricsRecord createRecord(string recordName
			);
		...
		/// </param>
		public abstract void registerUpdater(org.apache.hadoop.metrics.Updater updater);

		/// <summary>Removes a callback, if it exists.</summary>
		/// <param name="updater">object to be removed from the callback list</param>
		public abstract void unregisterUpdater(org.apache.hadoop.metrics.Updater updater);
		...
		public abstract System.Collections.Generic.IDictionary<string, System.Collections.Generic.ICollection
