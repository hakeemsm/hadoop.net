...
namespace org.apache.hadoop.io.compress
{
	...
	/// </remarks>
	public abstract class SplitCompressionInputStream : org.apache.hadoop.io.compress.CompressionInputStream
	{
		private long start;
		...
		public SplitCompressionInputStream(java.io.InputStream @in, long start, long end)
			: base(@in)
		{
			this.start = start;
			this.end = end;
