...
namespace Org.Apache.Hadoop.Mapreduce.Lib.Input
{
	...
	/// </remarks>
	public class CompressedSplitLineReader : SplitLineReader
	{
		internal SplitCompressionInputStream scin;
		...
		public CompressedSplitLineReader(SplitCompressionInputStream @in, Configuration conf
