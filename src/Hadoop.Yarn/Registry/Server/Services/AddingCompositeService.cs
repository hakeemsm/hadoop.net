...
{
	/// <summary>Composite service that exports the add/remove methods.</summary>
	/// <remarks>
	...
	/// </remarks>
	public class AddingCompositeService : CompositeService
	{
		...
		protected override void AddService(Org.Apache.Hadoop.Service.Service service)
		{
			base.AddService(service);
		}

		protected override bool RemoveService(Org.Apache.Hadoop.Service.Service service)
		{
			return base.RemoveService(service);
		}
	}
}
