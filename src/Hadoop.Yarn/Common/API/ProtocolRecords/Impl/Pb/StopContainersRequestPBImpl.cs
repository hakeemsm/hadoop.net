...
{
	public class StopContainersRequestPBImpl : StopContainersRequest
	{
		internal YarnServiceProtos.StopContainersRequestProto proto = YarnServiceProtos.StopContainersRequestProto
			.GetDefaultInstance();

		internal YarnServiceProtos.StopContainersRequestProto.Builder builder = null;
		...
		{
			builder = YarnServiceProtos.StopContainersRequestProto.NewBuilder();
		}
		...
		private void MaybeInitBuilder()
		{
			...
			{
				builder = YarnServiceProtos.StopContainersRequestProto.NewBuilder(proto);
			}
			viaProto = false;
		}
		...
		private void InitLocalContainerIds()
		{
			...
			YarnServiceProtos.StopContainersRequestProtoOrBuilder p = viaProto ? proto : builder;
