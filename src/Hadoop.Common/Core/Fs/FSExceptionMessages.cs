...
namespace Org.Apache.Hadoop.FS
{
	...
	public class FSExceptionMessages
	{
		...
		/// <value/>
		/// </summary>
		public const string NegativeSeek = "Cannot seek to a negative offset";

		/// <summary>
		/// Seeks :
		/// <value/>
		/// </summary>
		public const string CannotSeekPastEof = "Attempted to seek or read past the end of the file";
	}
}
