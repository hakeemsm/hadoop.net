...
namespace Org.Apache.Hadoop.Security.Authentication.Server
{
	...
	public abstract class AuthenticationHandler
	{
		...
		public abstract bool ManagementOperation(AuthenticationToken token, HttpServletRequest
		...
		/// <exception cref="Org.Apache.Hadoop.Security.Authentication.Client.AuthenticationException
		/// 	">thrown if an Authentication error occurred.</exception>
		public abstract AuthenticationToken Authenticate(HttpServletRequest request, HttpServletResponse
			 response);
	}
