...
{
	public class MKNOD3Response : NFS3Response
	{
		...
		public static Org.Apache.Hadoop.Nfs.Nfs3.Response.MKNOD3Response Deserialize(XDR 
			xdr)
		{
			...
			return new Org.Apache.Hadoop.Nfs.Nfs3.Response.MKNOD3Response(status, objFileHandle
